# RetinaNet Model to Detect Person/Cars

- In this repository we leverage RetinaNet model to train a Object Detection model to detect Person and Car accurately.
- Performance metrics from the trained model are mentioned below
...
- Trained model object is present in ./model
- Predictions from the model object are present in ./predictions_from_model
...
# Please find below the Steps to train the RetinaNet model for coco and custom dataset (Taken from the original repository https://github.com/yhenon/pytorch-retinanet)
